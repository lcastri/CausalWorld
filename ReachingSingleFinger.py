...
class ReachingSingleFinger(BaseTask):
    ...
    def _calculate_dense_rewards(self, desired_goal, achieved_goal):
        ...
        previous_dist_to_goal = np.linalg.norm(
            end_effector_positions_goal - self.previous_end_effector_positions[0:3])
        current_dist_to_goal = np.linalg.norm(end_effector_positions_goal -
                                              current_end_effector_positions[0:3])
        rewards = list()
    ...
    def _goal_reward(self, achieved_goal, desired_goal):
        ...
        :return:
        """
        current_end_effector_positions = achieved_goal[0:3]
    ...
    def _set_intervention_space_a(self):
        ...
        :return:
        """
        super(ReachingSingleFinger, self)._set_intervention_space_a()
    ...
    def _set_intervention_space_b(self):
        ...
        :return:
        """
        super(ReachingSingleFinger, self)._set_intervention_space_b()
